...
class Token(Base):
    ...
    start_time = Column(DateTime(timezone=True), nullable=True) # Alias for started_at
    end_time = Column(DateTime(timezone=True), nullable=True)   # Alias for completed_at
